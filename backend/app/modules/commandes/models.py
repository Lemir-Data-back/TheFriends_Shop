...
class Order(Base):
    ...
    # Négociation (sur mesure uniquement) — conversation libre client/couturier.
    # [{"auteur": "client"|"shop", "action": "proposer"|"contre"|"accepter"|"refuser",
    #   "prix": 40000|None, "message": "..."|None, "created_at": "2026-01-01T00:00:00Z"}]
    negociations: Mapped[list] = mapped_column(JSONB, default=list)

    # Délai de confection promis par le couturier à l'acceptation (en jours)
    delai_confection_jours: Mapped[int | None] = mapped_column(Integer, nullable=True)
