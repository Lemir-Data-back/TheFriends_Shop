  ...
  return (
    <div className="min-h-screen bg-tf-bg">
      <div className="max-w-screen-md mx-auto px-4 py-8">
        <h1 className="font-sans text-h2 font-bold text-tf-text mb-6">Mes commandes</h1>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <Link href="/shopping" className="px-6 py-3 bg-tf-gold text-tf-black rounded-md font-bold text-[14px] hover:bg-tf-gold-light transition-colors">
              Aller en shopping
            </Link>
          </div>
        ) : (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    <span className="font-sans text-[15px] font-bold text-tf-black">{formatPrix(order.montant)}</span>
